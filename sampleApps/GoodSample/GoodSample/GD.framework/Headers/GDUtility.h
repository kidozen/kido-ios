 ...
 *                   server as part of the token validation response. The
 *                   additional identification can be empty.
 *
 * Passing <TT>nil</TT> for either parameter is allowed and has the same effect as
